...
<%@page import="businesscomponent.model.Utente"%>
<%
	Utente u = new Utente();
...
<script src="js/updateValidazione.js"></script>
</head>
<body>
...
<%
	if(((boolean) session.getAttribute("mod")) == true){
%>
...
<form id="updateUserForm" action="/<%=application.getServletContextName()%>/aggiorna" method="post"
...
<div class="form-group">
	...
	<div class="col-md-4 inputGroupContainer">
		<div class="input-group">
			...
			<input type="text" name="username" id="username" placeholder="<%= user %>" class="form-control" disabled>
		</div>
	</div>
...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">
  Aggiorna Profilo &nbsp;<span class="glyphicon glyphicon-send"></span>
</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p> Salvare le modifiche apportate? </p>
      </div>
